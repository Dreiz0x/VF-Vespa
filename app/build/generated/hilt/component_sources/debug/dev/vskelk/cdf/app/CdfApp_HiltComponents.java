...
import dev.vskelk.cdf.core.network.di.NetworkModule;
import dev.vskelk.cdf.data.repository.di.RepositoryModule;
import dev.vskelk.cdf.data.repository.worker.PendingMessagesSyncWorker_HiltModule;
...
public final class CdfApp_HiltComponents {
  private CdfApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          NetworkModule.class,
          PendingMessagesSyncWorker_HiltModule.class,
