...
import dev.vskelk.cdf.feature.chaos.ChaosViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vskelk.cdf.feature.chaos.ChaosViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import dev.vskelk.cdf.feature.diagnostico.DiagnosticoViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vskelk.cdf.feature.diagnostico.DiagnosticoViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import dev.vskelk.cdf.feature.entrevista.EntrevistaViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vskelk.cdf.feature.entrevista.EntrevistaViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import dev.vskelk.cdf.feature.main.MainViewModel;
import dev.vskelk.cdf.feature.main.MainViewModel_HiltModules;
import dev.vskelk.cdf.feature.main.MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vskelk.cdf.feature.main.MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import dev.vskelk.cdf.feature.simulador.SimuladorViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vskelk.cdf.feature.simulador.SimuladorViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerCdfApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends CdfApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(5).put(ChaosViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, ChaosViewModel_HiltModules.KeyModule.provide()).put(DiagnosticoViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, DiagnosticoViewModel_HiltModules.KeyModule.provide()).put(EntrevistaViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, EntrevistaViewModel_HiltModules.KeyModule.provide()).put(MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, MainViewModel_HiltModules.KeyModule.provide()).put(SimuladorViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, SimuladorViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends CdfApp_HiltComponents.ViewModelC {
    ...
    Provider<ChaosViewModel> chaosViewModelProvider;

    Provider<DiagnosticoViewModel> diagnosticoViewModelProvider;

    Provider<EntrevistaViewModel> entrevistaViewModelProvider;
    ...
    ToggleOfflineModeUseCase toggleOfflineModeUseCase() {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.diagnosticoViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.entrevistaViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.mainViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
      this.simuladorViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(5).put(ChaosViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (chaosViewModelProvider))).put(DiagnosticoViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (diagnosticoViewModelProvider))).put(EntrevistaViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (entrevistaViewModelProvider))).put(MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (mainViewModelProvider))).put(SimuladorViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (simuladorViewModelProvider))).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // dev.vskelk.cdf.feature.diagnostico.DiagnosticoViewModel
          return (T) new DiagnosticoViewModel(viewModelCImpl.observeReactivoDiagnosticsUseCase());

          case 2: // dev.vskelk.cdf.feature.entrevista.EntrevistaViewModel
          return (T) new EntrevistaViewModel(viewModelCImpl.observeInterviewNodesUseCase());

          case 3: // dev.vskelk.cdf.feature.main.MainViewModel
          ...
          case 4: // dev.vskelk.cdf.feature.simulador.SimuladorViewModel
  ...
  private static final class SingletonCImpl extends CdfApp_HiltComponents.SingletonC {
    ...
    Provider<DataStore<UserPreferences>> provideUserPreferencesStoreProvider;

    Provider<CipherService> cipherServiceProvider;

    Provider<PreferencesDataSource> preferencesDataSourceProvider;
    ...
    Provider<CertificatePinsProvider> provideCertificatePinsProvider;

    Provider<CertificatePinner> provideCertificatePinnerProvider;

    Provider<OkHttpClient> provideOkHttpProvider;

    Provider<Json> provideJsonProvider;

    Provider<AnthropicApi> provideAnthropicApiProvider;

    Provider<ConversationRepositoryImpl> conversationRepositoryImplProvider;

    Provider<PendingMessagesSyncWorker_AssistedFactory> pendingMessagesSyncWorker_AssistedFactoryProvider;

    Provider<WorkManager> provideWorkManagerProvider;

    Provider<PendingSyncScheduler> pendingSyncSchedulerProvider;

    Provider<ConnectivityNetworkMonitor> connectivityNetworkMonitorProvider;

    Provider<ChaosRepositoryImpl> chaosRepositoryImplProvider;

    Provider<ReactivoRepositoryImpl> reactivoRepositoryImplProvider;

    Provider<OntologyRepositoryImpl> ontologyRepositoryImplProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.connectivityNetworkMonitorProvider = DoubleCheck.provider(new SwitchingProvider<ConnectivityNetworkMonitor>(singletonCImpl, 18));
      this.chaosRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<ChaosRepositoryImpl>(singletonCImpl, 17));
      this.reactivoRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<ReactivoRepositoryImpl>(singletonCImpl, 19));
      this.ontologyRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<OntologyRepositoryImpl>(singletonCImpl, 20));
      this.settingsRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<SettingsRepositoryImpl>(singletonCImpl, 21));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 17: // dev.vskelk.cdf.data.repository.repository.ChaosRepositoryImpl
          ...
          case 18: // dev.vskelk.cdf.core.common.ConnectivityNetworkMonitor
          ...
          case 19: // dev.vskelk.cdf.data.repository.repository.ReactivoRepositoryImpl
          return (T) new ReactivoRepositoryImpl(singletonCImpl.reactivoDao());

          case 20: // dev.vskelk.cdf.data.repository.repository.OntologyRepositoryImpl
          return (T) new OntologyRepositoryImpl(singletonCImpl.ontologyDao());

          case 21: // dev.vskelk.cdf.data.repository.repository.SettingsRepositoryImpl
